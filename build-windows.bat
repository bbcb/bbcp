@echo off
@echo DevCompiler.CompileSubs @Win Com Comm Ctl Dev Form Ole Sql Std System Text Win Cons Mdi Fig Obx Paket >> tmp.txt
...
@echo DevLinker.Link dos BlackBoxInterp.exe := Kernel$+ Utf WinKernel Files WinEnv WinFiles StdLoader WinIntLoader >> tmp.txt
